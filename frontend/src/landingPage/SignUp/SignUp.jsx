    ...
    <div className="row mb-5 mt-3">
      ...
      >
        ...
        <div className="col pl-5">
          <h1 className="fs-3 fw-medium" style={{ color: "#424242" }}>Signup now</h1>
          <h2 className="fs-6 fw-medium mt-2" style={{ color: "#a2a2a2" }}>Or track your existing application</h2>
          <form onSubmit={handleSubmit} className="needs-validation mt-4" novalidate>
            <div className="input-group mb-3">
              <input type="text" value={username} onChange={(e) => setUsername(e.target.value)} className="form-control" placeholder="Enter Your Username" aria-label="Username" aria-describedby="basic-addon1" required />
            ...
            <div>
              ...
              <div id="passwordHelpBlock" className="form-text mt-1" style={{ color: "#a2a2a2", fontSize: "0.875rem" }}>
